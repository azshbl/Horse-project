...
trainees = {
    ...
    1: {
        ...
        "completed_classes": 5,
        "package": 10,
        "assigned_trainer": "Abdullah",
        "assigned_horse": "Rahaf",
        "license": False
    },

    2: {
        "trainee_name": "Mohammed",
        "age": 23,
        "training_type": "Racing",
        "level": "Intermediate",
        "completed_classes": 18,
        "package": 20,
        "assigned_trainer": "Nawaf",
        "assigned_horse": "Mazyon",
        "license": False
    },
    ...
    3: {
        ...
        "package": 40,
        "assigned_trainer": "Turki",
        "assigned_horse": "Wadah",
        "license": False
    },
    ...
    4: {
        ...
        "package": 40,
        "assigned_trainer": "Abdulaziz",
        "assigned_horse": "Shamekh",
        "license": True
    }
...
def register_trainee():
    ...
    while True:
        ...
        training_type = input(
            "Choose training type (Jumping / Racing / For fun): "
        ).title()

        if training_type in ["Jumping", "Racing", "For Fun"]:
            break
