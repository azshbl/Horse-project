...
trainers = {
    1: {"trainer_name": "Turki", "age": 24, "training_type": "Jumping, For fun,", "sessions_completed": 70, "performance_score": 99},
    2: {"trainer_name": "Abdulaziz", "age": 24, "training_type": "Jumping", "sessions_completed": 56, "performance_score": 95},
    3: {"trainer_name": "Nawaf.z", "age": 24, "training_type": "For fun", "sessions_completed": 20, "performance_score": 95},
    4: {"trainer_name": "Nawaf", "age": 24, "training_type": "Racing", "sessions_completed": 50, "performance_score": 90},
    5: {"trainer_name": "Khalid", "age": 22, "training_type": "Racing", "sessions_completed": 30, "performance_score": 85},
    6: {"trainer_name": "Saud", "age": 20, "training_type": "For fun", "sessions_completed": 10, "performance_score": 80},
...
trainees = {
    1: {"trainee_name": "Ahmed", "age": 20, "training_type": "Jumping", "completed_classes": 5, "package": 10, "license": False},
    2: {"trainee_name": "Mohammed", "age": 23, "training_type": "Racing", "completed_classes": 18, "package": 20, "license": False},
    3: {"trainee_name": "Khalid", "age": 25, "training_type": "For fun", "completed_classes": 35, "package": 40, "license": False},
    4: {"trainee_name": "Saad", "age": 21, "training_type": "Jumping", "completed_classes": 40, "package": 40, "license": True}
}
...
def show_horses():
    ...
    for horse_num, horse in horses.items():
        ...
        print(f"Owner: {horse['owner_name']}")
...
def best_trainer():
    ...
    print("\n===== BEST TRAINER =====")
    print(f"Trainer Name: {best['trainer_name']}")
...
def show_trainees():
    ...
    for trainee_id, trainee in trainees.items():
        ...
        print(f"License: {trainee['license']}")
        print("-" * 30)
...
def horse_records():
    ...
    print(f"Arabian Horses: {arabian_count}")
